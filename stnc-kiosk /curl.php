...
/*
  ...
  //çalışan 
  wget -q -O /dev/null "https://erciyesteknopark.com/curl.php?dghjghhdd=sssd&sageon=hava" > /dev/null 2>&1
  wget -q -O /dev/null "https://erciyesteknopark.com/curl.php?dghjghhdd=sssd&sageon=exchange" > /dev/null 2>&1

  
  //çalışmadı tekrar denenebilir 
  wget -q --spider 'https://erciyesteknopark.com/curl.php?dghjghhdd=sssd&sageon=hava'	
