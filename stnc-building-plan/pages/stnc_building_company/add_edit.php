...
$building_id=isset($_GET['building_id']) ? $_GET['building_id'] : 1 ;
    ...
    <div class="stnc-container-fluid">
        ...
        <?php if  ($is_empty === "1") :   ?>
         ...
         <input type="hidden" value="<?php echo $media_id ?>" name="media_id" id="media_id">
                    <input type="hidden" value="<?php echo isset($floors_locations_id) ? $floors_locations_id  : 1?>" name="floors_locations_id" id="floors_locations_id">
        <div class="stnc-row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="door_number" value="<?php echo isset($door_number) ? $door_number  : 1 ?>"
            ...
            <br>
                ...
                <div class="form-group">
                   ...
                   <?php  if ((isset($_GET['st_trigger'])) && ($_GET['st_trigger'] === 'show')) : 
                    ...
                    ?>
                    <div class="background_attachment_metabox_container">  <img class="img-fluid" src=" <?php echo isset($image[0]) ? $image[0] : "" ;  ?> " alt="">  </div>
                    <?php else : ?>
