...
<tbody>
  <tr>
    ...
    <th style="font-family: sans-serif; font-size: 15px; font-weight:bold; vertical-align: top;  text-align: center; padding:10px;  color:blue;border:solid #000 1px " valign="top" align="right" scope="col" scope="col"> </th>

    <th style="font-family: sans-serif; font-size: 15px; font-weight:bold; vertical-align: top;  text-align: center; padding:10px;  color:blue;border:solid #000 1px " valign="top" align="right" scope="col" scope="col">Doluluk </th>

    <th style="font-family: sans-serif; font-size: 15px; font-weight:bold; vertical-align: top;  text-align: center; padding:10px;  color:blue;border:solid #000 1px " valign="top" align="right" scope="col" scope="col"><?php esc_html_e( 'Total Office', 'the-stnc-map' ) ?> </th>

    <th style="font-family: sans-serif; font-size: 15px; font-weight:bold; vertical-align: top;  text-align: center; padding:10px;  color:blue;border:solid #000 1px " valign="top" align="right" scope="col" scope="col"><?php esc_html_e( 'Empty Office', 'the-stnc-map' ) ?> </th>

    <th style="font-family: sans-serif; font-size: 15px; font-weight:bold; vertical-align: top;  text-align: center; padding:10px;  color:blue;border:solid #000 1px " valign="top" align="right" scope="col" scope="col"><?php esc_html_e( 'Full Office', 'the-stnc-map' ) ?> </th>
