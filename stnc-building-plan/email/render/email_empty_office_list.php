...
<tbody>
  <tr>
    <td align="left" style="font-family: sans-serif; font-size: 14px; vertical-align: top; padding-bottom: 15px;" valign="top">
	  ...
	  <thead>
		<tr>
			<th style="font-family: sans-serif; font-size: 15px; font-weight:bold; vertical-align: top;  text-align: center; padding:10px;  color:blue;border:solid #000 1px " valign="top" align="right" scope="col">Bina / Kat </th>
			<th style="font-family: sans-serif; font-size: 15px; font-weight:bold; vertical-align: top;  text-align: center; padding:10px;  color:blue;border:solid #000 1px " valign="top" align="right" scope="col">Ofis Numarasi</th>
